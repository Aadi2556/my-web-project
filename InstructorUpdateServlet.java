...
@WebServlet("/secure/instructorUpdate")
public class InstructorUpdateServlet extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            InstructorUpdate instructorUpdate = gson.fromJson(req.getReader(), InstructorUpdate.class);
            boolean success = UserStorage.updateUser(originalEmail, instructorUpdate);
