...
public class StudentLoginServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        StudentLogin studentLogin = new Gson().fromJson(reqReader, StudentLogin.class);
        boolean validPass = UserStorage.validateUser(studentLogin.getUserEmail(), studentLogin.getUserPassword());
        ...
        if (validPass) {
            // Changed to use getStudentRegister() instead of getUser()
            StudentRegister user = UserStorage.getStudentRegister(studentLogin.getUserEmail());
